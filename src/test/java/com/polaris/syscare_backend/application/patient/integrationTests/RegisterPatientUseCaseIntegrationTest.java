...
import com.polaris.syscare_backend.infrastructure.persistence.user.UserJpaRepository;
...
class RegisterPatientUseCaseIntegrationTest
{
    ...
    void shouldEncodePasswordWhenRegisteringPatient()
    {
        ...
        var command = new RegisterPatientCommand(
                ...
                "ana@email.com",
                "(11)99999-8888",
                "secret123" // novo campo se existir
        );

        useCase.execute(command);

        UserEntity user = userJpaRepository.findByEmail("ana@email.com")
                .orElseThrow();
